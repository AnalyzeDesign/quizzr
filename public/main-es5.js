(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            AddPostService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AddPostComponent = /** @class */ (function () {
                function AddPostComponent(addPostService, flashMsg, commonService) {
                    var _this = this;
                ...
                AddPostComponent.prototype.ngOnInit = function () {
                    ...
                    jquery__WEBPACK_IMPORTED_MODULE_5__('#jqueryMovieSearchSubmit').click(function (e) {
                        var qry = jquery__WEBPACK_IMPORTED_MODULE_5__('#movieSearchTerms').val();
                        var jquri = 'https://api.nytimes.com/svc/movies/v2/reviews/search.json?query=' + qry + '&api-key=tVMze8krMOMw8r3UibJbiZC1rqx9c7hd';
                ...
                AddPostComponent.prototype.addPostBtnClick = function () {
                    var _this = this;
                    if (this.post.title && this.post.description && this.post.question_one && this.post.answer_one) {
                        if (this.post._id) {
                            ...
                            this.addPostService.updatePost(this.post).subscribe(function (res) {
                                ...
                                _this.addBtn.nativeElement.click();
                                _this.flashMsg.show('Quiz edited!', { cssClass: 'alert-success', timeout: 5000 });
                                jquery__WEBPACK_IMPORTED_MODULE_5__('html, body').animate({
                                    scrollTop: jquery__WEBPACK_IMPORTED_MODULE_5__(".navbar").offset().top
                                }, 1000);
                            });
                            ...
                            this.addPostService.addPost(this.post).subscribe(function (res) {
                                ...
                                _this.flashMsg.show('New Quiz added!', { cssClass: 'alert-success', timeout: 5000 });
                                jquery__WEBPACK_IMPORTED_MODULE_5__('html, body').animate({
                                    scrollTop: jquery__WEBPACK_IMPORTED_MODULE_5__(".navbar").offset().top
                                }, 1000);
                            });
                ...
                LoginComponent.prototype.onLoginSubmit = function () {
                    ...
                    this.authService.authenticateUser(user).subscribe(function (data) {
                        ...
                        if (data.success) {
                            ...
                            _this.flashMsg.show('You are now logged in', { cssClass: 'alert-success', timeout: 5000 });
                ...
                RegisterComponent.prototype.onRegisterSubmit = function () {
                    ...
                    this.authService.registerUser(user).subscribe(function (data) {
                        if (data["success"] === true) { //data.success){
                            _this.flashMsg.show('You are now registered and can log in', { cssClass: 'alert-success', timeout: 3000 });
                            console.log('data', data);
                            _this.router.navigate(['/login']);
                        }
                        else {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            ShowPostService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ShowPostComponent = /** @class */ (function () {
                function ShowPostComponent(showPostService, commonService) {
                ...
                ShowPostComponent.prototype.setDelete = function (post) {
            ...
            ShowPostComponent.ctorParameters = function () { return [
